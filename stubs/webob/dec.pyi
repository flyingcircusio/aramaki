...
class wsgify:
    ...
    def __init__(self, func: Incomplete | None = None, RequestClass: Incomplete | None = None, args=(), kwargs: Incomplete | None = None, middleware_wraps: Incomplete | None = None) -> None: ...
